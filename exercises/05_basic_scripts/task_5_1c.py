...
# answer
# print(london_co['r2'].get('ioss','Такого ключа нет')) # метод get для вложенных словарей

a = (input('Введите имя устройства: r1, r2 или sw1: '))
c = ','.join(london_co['{}'.format(a)].keys())  # извлекаем строку ключей из выбранного подсловаря r1, r2, sw1
b = (
    input('Введите имя параметра ({}): '.format(c)))  # подставляем строку извлеченных ключей в качестве подсказки ввода
print('-' * 50)
print(a)
print(b)
print(london_co['{}'.format(a)].get('{}'.format(b), 'Такого параметра нет'))
